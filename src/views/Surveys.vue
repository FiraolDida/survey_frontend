    ...
    <div v-else>
      ...
      <div class="flex justify-center mt-5">
        <nav class="relative z-0 inline-flex justify-center rounded-md shadow-sm" aria-label="Pagination">
          <a v-for="(link, i) of surveys.links" :key="i" :disabled="!link.url" v-html="link.label" href="#" @click="getForPage($event, link)" aria-current="page"
...
function deleteSurvey(survey) {
  if (confirm(`Are you sure you want to delete this sruvey? Operations can't be undone!!`)){
